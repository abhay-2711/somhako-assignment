...
const Header = () => {
  ...
  return (
    ...
    <div className='flex flex-col md:flex-row items-center pl-16 pr-10 md:h-20 bg-white border-b-2'>
      <div className='w-42 flex items-center justify-center mb-4'>
      <Image
        src={somhako_logo}
        alt='Somhako'
        width={300}
      ...
      />
      <h3 className='font-bold text-gray-500'>Somhako</h3>
      </div>

      <div className='flex flex-col md:flex-row items-center md:space-y-0 md:space-x-5 flex-1 justify-end w-full gap-5 mb-4'>
